...
export const BUILTINS: BuiltinSpec[] = [
  ...
  { name: "smelt", params: [p("item", "item"), p("n", "int", "1")], returns: "record", doc: "Smelt in a nearby furnace.", blocking: true, stub: true },
  ...
  { name: "sleep", params: [], returns: "record", doc: "Find a bed and sleep.", blocking: true, stub: true },
