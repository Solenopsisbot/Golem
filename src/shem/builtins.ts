...
export const BUILTINS: BuiltinSpec[] = [
  ...
  { name: "shoot", params: [p("target", "any"), p("shots", "int", "1"), p("charge", "int", "25")], returns: "int", doc: "Draw your bow at an entity or a position and loose; returns shots fired. Needs a bow and arrows. No lead: best against crystals, perched dragons and things coming at you.", blocking: true },
